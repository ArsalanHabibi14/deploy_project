(function ($) {
  ...
  HAMTA.StickyHeader = function () {
    ...
    if ($(".page-header").length) {
      $(".page-content").css(
        "margin-top",
        pageHeaderheight + navWrapperheight + 15
      );
    }
  ...
  HAMTA.CategoryList = function () {
    ...
    $(".category-list, .mega-menu").on("mouseenter", function () {
      $(this).addClass("is-active");
      $(".page-header-overlay").fadeIn(200);
    });
    $(".category-list, .mega-menu").on("mouseleave", function () {
      $(this).removeClass("is-active");
  ...
  HAMTA.FilterPrice = function () {
    if ($(".filter-price").length) {
      ...
      skipSlider.noUiSlider.on('set', filterProducts);
  ...
  $(document).ready(function () {
    HAMTA.StickyHeader(),
      ...
      HAMTA.FilterOptions(),
      HAMTA.StickySidebar(),
      HAMTA.FilterOptionsSidebar(),
      HAMTA.ResponsiveTabOrderList(),
      HAMTA.ZoomImage(),
      HAMTA.ColorSwitcher();
  });
})(jQuery);
