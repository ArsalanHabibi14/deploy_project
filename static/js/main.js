$(document).ready(function () {
    $(".user-item.account").mouseover(function () {
        $(".page-header-overlay").fadeIn(1);
    });
    $(".user-item.account").mouseleave(function () {
        $(".page-header-overlay").fadeOut(1);
    });
    $(".user-item.cart-list.basket-content").mouseover(function () {
        $(".page-header-overlay").fadeIn(1);
    });
    $(".user-item.cart-list.basket-content").mouseleave(function () {
        $(".page-header-overlay").fadeOut(1);
    });
})
function irancitylist(state)
{
	with(document.getElementById('add-city-input'))
	{
		options.length = 0;
	...
	with(document.getElementById('edit-city-input'))
	{
		options.length = 0;
...
// $("#contactformmessage").on("keypress", function(event) {
//     var persianAlphabetDigitsAndWhiteSpace = /^[\u0600-\u06FF\s]+$/;
//     var key = String.fromCharCode(event.which);
//     if (event.keyCode == 8 || event.keyCode == 37 || event.keyCode == 39 || persianAlphabetDigitsAndWhiteSpace.test(key)) {
//         return true;
//     }
//     return false;
// });
// $('#contactformmessage').on("paste",function(e)
// {
//     e.preventDefault();
// });